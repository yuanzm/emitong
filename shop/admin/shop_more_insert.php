...
<div class="container">
	...
	<div class="shop_more_insert_content">

		<form class="form-horizontal" role="form" method="post" action="do_more_insert.php" enctype="multipart/form-data">

			<div class="form-group">
				<label for="more_name" class="col-sm-3 control-label">名称 <span class="text-muted">*</span></label>
				<div class="col-sm-7">
					<input type="text" class="form-control" id="more_name" name="more_name" value="" placeholder="10个字以内">
				</div>
			</div>

			<div class="form-group">
				<label for="more_emi_price" class="col-sm-3 control-label">益米价 <span class="text-muted">*</span></label>
				<div class="col-sm-7">
					<input type="text" class="form-control" id="more_emi_price" name="more_emi_price" value="" placeholder="由数字和小数点组成">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="text" class="form-control" id="more_price" name="more_price" value="" placeholder="由数字和小数点组成">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<textarea type="text" class="form-control" id="more_description" name="more_description" rows="4" maxlength=120 placeholder="默认为空"></textarea>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="file" class="form-control" id="more_img" name="more_img" accept="image/jpg, image/jpeg">
				</div>
			</div>

			<div class="form-group">
				<div class="more_btn col-sm-offset-3 col-sm-7">

					<button type="submit" class="btn btn-primary"  data-loading-text="提交中.." id="more_new_submit" name="more_new_submit">
